...
>
  {#if product}
    <!-- Modal Content Grid matching design/index.html -->
      ...
      <div class="md:col-span-5 flex flex-col gap-3">
        ...
        <div class="grid grid-cols-4 gap-2">
          {#each galleryImages as img, idx}
            <button
              type="button"
              class="h-16 bg-[#0c0e14] border-2 {activeImageIndex === idx ? 'border-vault-gold' : 'border-[#3b3221] hover:border-vault-gold/70'} rounded overflow-hidden focus:outline-none transition-colors cursor-pointer"
      ...
      <div class="md:col-span-7 flex flex-col gap-4">
        ...
        <div class="flex items-center gap-3 pt-2">
          ...
          <div class="flex items-center bg-[#171a24] border border-[#4d3f26] rounded">
            <button
              type="button"
              class="px-3 py-2 text-gray-400 hover:text-white font-bold transition-colors cursor-pointer"
          ...
          <!-- Primary Add Button using VaultButton -->
          <VaultButton
            variant="gold"
            size="lg"
            class="flex-1"
