...
- [x] 3.2. Реализовать состояние корзины `src/lib/state/cart.svelte.ts` на Svelte 5 Runes:
  ...
  - `$derived hasBundleDiscount` и `bundleDiscount` — скидка на бандл 10% при покупке стартера или >= 3 миниатюр одной фракции (по SPEC_ORDERS.md).
  - `$derived promoDiscount` — скидка по промокодам (`WARHAMMER10`, `TERRA10`, `EMPEROR20`, `WARP-TITHE-10`).
...
- [x] 4.5. `CartDrawer.svelte`:
  ...
  - Баннер сургучной печати бандл-скидки 10%.
  - Поле ввода промокода с валидацией (`WARHAMMER10`, `TERRA10`, `EMPEROR20`, `WARP-TITHE-10`).
...
- [x] 5.2. Сквозные сценарии проверки:
  ...
  - Сценарий 3: Добавление товаров активирует бандл-скидку 10% (при наличии стартера или 3+ миниатюр одной фракции) и сургучную печать чистоты.
  - Сценарий 4: Применение промокода `WARHAMMER10`, `TERRA10` или `WARP-TITHE-10` пересчитывает сумму.
